...
const AppScreen = ({
  ...
  const [homeButtonClass, setHomeButtonClass] =
    signal<string>("tws-translate-y-0");
  ...
  return (
    ...
    >
      ...
      <Container
        className={concat`tws-flex tws-items-center tws-justify-center ${homeButtonClass} tws-transition-transform tws-duration-500 peer-hover:tws-translate-y-0 `}
        style={{
          width: percentage(100),
          height: "fit-content",
          position: "absolute",
