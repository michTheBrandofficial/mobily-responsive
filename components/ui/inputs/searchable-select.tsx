			...
			>
				...
				>
					<motion.input
						...
						required={required}
						className={cn(
							`tws-font-normal tws-text-[#080808] placeholder:tws-font-normal placeholder:tws-text-[#f1f1f1]/80 tws-caret-sky-500 selection:tws-bg-sky-500 selection:tws-text-white  tws-w-full tws-text-sm tws-bg-transparent tws-py-1.5 tws-pb-2.5 focus:tws-outline-none`,
							{
	...
	return (
		<motion.div
			...
			className={cn(
				...
				{ "tws-bg-white tws-font-medium": option.isSelected },
				props.className,
			)}
