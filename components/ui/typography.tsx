...
const typographyVariants = cva("", {
  variants: {
    variant: {
      h1: "tws-scroll-m-20 tws-text-paragraph tws-font-Switzer tws-text-4xl tws-font-extrabold tws-tracking-tight lg:tws-text-5xl",
      h2: "tws-scroll-m-20 tws-text-paragraph tws-font-Switzer tws-text-3xl tws-font-semibold tws-tracking-tight",
      h3: "tws-scroll-m-20 tws-text-paragraph tws-font-Switzer tws-text-2xl tws-font-semibold tws-tracking-tight",
      h4: "tws-scroll-m-20 tws-text-paragraph tws-font-Switzer tws-text-xl tws-font-semibold tws-tracking-tight",
      h5: "tws-scroll-m-20 tws-text-paragraph tws-font-Switzer tws-text-lg tws-font-semibold tws-tracking-tight",
      p: "tws-leading-7 tws-font-medium tws-font-Switzer",
      pre: "tws-leading-7 tws-font-medium tws-font-Switzer",
      span: "tws-font-medium tws-font-Switzer",
    },
  },
  defaultVariants: {
    variant: "p",
...
interface TypographyProps
  extends React.HTMLAttributes<HTMLHeadingElement | HTMLPreElement>,
